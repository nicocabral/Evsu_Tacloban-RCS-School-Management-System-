                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <div class="alert alert-info"><strong style="font-size:16px;"><center>Parent Info</center></strong></div
                                        ></div>
									
                                        <div class="modal-body">
                                  
                              <form  method="post" action="result_process_user.php" enctype="multipart/form-data">
