                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel"><center>Search Grade and Grade level to import </center></h4>
                                        </div>
   ...
   <option>-------------------</option>
     ...
     <option value="Mars">Mars</option>
								...
								<div class = "modal-footer">
											...
											<a href="add_student.php" type="button" class="btn btn-default">Close</a>
								</div>
									  </form>  
                                        </div>
									   </div>
