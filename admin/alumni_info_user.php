 ...
 <div class="row">
      <div class="col-lg-2">
        ...
        <li style="text-align:center;"><a href="add_student_user.php" data-toggle="tooltip" title="Student's Record" data-placement="right"><span class="glyphicon glyphicon-user"></span>&nbsp;Student</a></li>
         ...
         <li style="text-align:center;"  class="active"><a href="alumniuser.php" data-toggle="tooltip" title="Teacher's Record" data-placement="right"><span class="glyphicon glyphicon-star"></span>&nbsp;Alumni</a></li>
        </ul>
        </div>
        </div>
        </div>
...
<ol class="breadcrumb">
  ...
  <li><a href="alumniuser.php">Alumni</a></li>
  <li> Search Result</li>
