  ...
  <div class="content-loader">
	   ...
	   while($row=mysql_fetch_array($query)){
		   $id = $row['id'];
			...
			<td style="text-align:center; width:auto;"><a href="grade_update_user.php?id=<?php echo $id;?>" role="button"  data-toggle="tooltip" title="Update Grade info?"><span class="glyphicon glyphicon-eye-open"></span></a>&nbsp; | &nbsp;
            <a href="print_user.php?id=<?php echo $id;?>" data-toggle="tooltip" title="Print?"><span class="glyphicon glyphicon-print"></span></a>
            </td>
			</tr>
			<?php
		}}
