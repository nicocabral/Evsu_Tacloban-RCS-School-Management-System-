...
<a href="#myModal<?php echo $id;?>" role="button"  data-toggle="modal" data-target="#myModal<?php echo $id;?>"><button class="btn btn-primary">Update Status</button></a><?php include('update_student.php');?> &nbsp;
