...
<?php $datefrom =@$_POST['date_from']; $dateto = @$_POST['date_to']; ?>
  ...
  &emsp;  &emsp;  &emsp;<button data-toggle="tooltip" title="Print?" onclick="printContent('div1')" ><img src="images/ico/printer.ico" width="30px;" /></button>&emsp; &emsp;<a href="alumni.php" data-toggle="tooltip" title="Back?"class="btn btn-danger">Back</a>
  <br /><br />
  <div id="div1">
