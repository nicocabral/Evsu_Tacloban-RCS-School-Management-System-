                                        ...
                                        <div class="panel-body">
                                            <?php 
                                                ...
                                                while($row = mysql_fetch_array($result)){
													$id = $row['id'];
                                            ?>
                                            <form role="form" action="act_update_processuser.php" method="POST">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <a href="#delete_act<?php echo $id;?>" role="button"  data-toggle="modal" data-target="#delete_act<?php echo $id;?>"><button class="btn btn-danger">Delete</button></a><?php include('deleteactivitiesuser.php');?>
                                                    </div>
                                                </div>
                                            </form>
                                            <?php } ?>
