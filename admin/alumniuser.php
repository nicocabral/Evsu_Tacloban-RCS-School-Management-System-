...
<ol class="breadcrumb">
 ...
 <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal"> <span class="glyphicon glyphicon-plus-sign"></span> &nbsp; Add Alumni</button> <?php include('add_alumniuser.php');?>
	 <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModalsearch"> <span class="glyphicon glyphicon-search"></span> &nbsp; Search by Batch</button> <?php include('search_alumnibybatchuser.php');?>
     <button class="btn btn-info" type="button" data-toggle="modal" data-target="#modalPrint"><span class="glyphicon glyphicon-print"></span> &nbsp; Print Alumni</button><?php include('alumni_printuser.php');?>
        <hr />
	...
	while($row=mysql_fetch_array($query)){?> <span class="badge" data-toggle="tooltip" title="Total no of Alumni" data-placement="right"><?php echo $row['total'];}?></span> </p>
		...
		{ $a_id = $row['id'];
		  //$name =$row['name'];
			...
			<a href="alumni_info_user.php?id=<?php echo $a_id?>" role="button"  data-toggle="tooltip" title="View info?"><span class="glyphicon glyphicon-eye-open"></span></a> 
             </td>
