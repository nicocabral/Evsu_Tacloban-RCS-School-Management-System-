...
<ol class="breadcrumb">
  ...
  <li>Student</a></li>
	 ...
	 <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModal"> <span class="glyphicon glyphicon-plus-sign"></span> &nbsp; Add Student</button> <?php include('add_student_processuser.php');
			  ?>
     <button class="btn btn-info" type="button" data-toggle="modal" data-target="#myModalsearch"> <span class="glyphicon glyphicon-search"></span> &nbsp; Search </button><?php include('search_process_user.php');?>
      ...
      <button class="btn btn-info" type="button" data-toggle="modal" data-target="#modalPrint"><span class="glyphicon glyphicon-print"></span> &nbsp;Print Student</button><?php include('grade_printuser.php');?>
      
       <button class="btn btn-info" type="button" data-toggle="modal" data-target="#modalParent"><span class="glyphicon glyphicon-search" data-toggle="tooltip" title="Search Mother/Guardian Occupation" ></span> &nbsp;Mother</button><?php include('parentuser.php');?>
       <a href="fatherinfouser.php" class="btn btn-info" type="button" data-toggle="tooltip" title="Click to View All Father/Guardian Information"><span class="glyphicon glyphicon-search"></span> &nbsp;Father</a>
        <hr /> 
  <div class="content-loader">
      ...
      
		{
			...
			<a href="student_infouser.php?id=<?php echo $row['id']; ?>" title="View info?" data-toggle="tooltip"><span class="glyphicon glyphicon-eye-open"></span></a>
