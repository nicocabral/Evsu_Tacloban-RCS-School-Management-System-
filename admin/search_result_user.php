 ...
 <div class="row">
      <div class="col-lg-2">
        ...
        <li style="text-align:center;"><a href="add_student_user.php" data-toggle="tooltip" title="Student's Record" data-placement="right"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;Student</a></li>
         <li style="text-align:center;"><a href="alumni_user.php" data-toggle="tooltip" title="Teacher's Record" data-placement="right"><span class="glyphicon glyphicon-star"></span>&nbsp;Alumni</a></li>
        </ul>
        </div>
        </div>
        </div>
	   ...
	   while($row=mysql_fetch_array($query)){
		   $id = $row['id'];
			...
			<td style="text-align:center; width:auto;"><?php echo  $row['status'];?> &nbsp;|&nbsp;<a href="#myModalgrade<?php echo $id;?>" role="button"  data-toggle="modal" data-target="#myModalgrade<?php echo $id;?>"><span class="glyphicon glyphicon-eye-open" data-toggle="tooltip" title="View Parent Info?"></span></a></td>
             ...
             <?php include('grade_process_user.php');?>
			<?php
		}}}
		?>
        </tbody>
