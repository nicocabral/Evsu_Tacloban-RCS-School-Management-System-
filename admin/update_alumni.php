<div class="modal fade" id="myModal<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              ...
                              <div class="control-group">
                                           <label class="control-label" for="inputEmail">Alumni no:</label>
                                           <input type="text" name="id" class = "form-control" value = "<?php echo $row['id'];?>" readonly="readonly">
                                ...
                                <div class="control-group">
                                  ...
                                  <div class="control-group">
                                           <label class="control-label" for="inputEmail">Achievements:</label>
                                           <input type="text" name="achvmnts" class = "form-control" value = "<?php echo $row['achievements'];?>" required />
                                          
                                 </div>
                                 <div class="control-group">
                                           <label class="control-label" for="inputEmail">Motto:</label>
