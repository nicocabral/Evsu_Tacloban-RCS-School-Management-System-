                        		...
                        		<div class="control-group">
                                 ...
                                 <div class="control-group">
                                  ...
                                  <div class="control-group">
                                           ...
                                           <input type="text" name="moto" class = "form-control" placeholder="Ex. 090912334556" required>
                                          
                                 </div>
                                <div class="control-group">
                                           <label class="control-label" for="inputEmail">Email:</label>
                                           <input type="email" name="achvmnts" class = "form-control" placeholder="Email @yahoo.vom" required>
