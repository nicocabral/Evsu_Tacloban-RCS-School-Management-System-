...
<body>
<?php $grades =mysql_real_escape_string(@$_POST['grade']); $section = mysql_real_escape_string(@$_POST['sec']); ?>
  <div class="content-loader">
  
  &emsp;  &emsp;  &emsp;<button data-toggle="tooltip" title="Print?" onclick="printContent('div1')" ><img src="images/ico/printer.ico" width="30px;" /></button>&emsp; &emsp;<a href="add_student_user.php" data-toggle="tooltip" title="Back?"class="btn btn-danger">Back</a>
  <br /><br />
  <div id="div1">
